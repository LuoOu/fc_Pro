...
#define SBK_QTWIDGETS_QLIST_QABSTRACTANIMATIONPTR_IDX                17 // QList<QAbstractAnimation* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTSTATEPTR_IDX                    18 // const QList<QAbstractState* > &
#define SBK_QTWIDGETS_QLIST_QWIDGETPTR_IDX                           19 // QList<QWidget* >
#define SBK_QTWIDGETS_QLIST_QWINDOWPTR_IDX                           20 // QList<QWindow* >
#define SBK_QTWIDGETS_QLIST_QSCREENPTR_IDX                           21 // QList<QScreen* >
...
#define SBK_QTWIDGETS_QLIST_QLISTWIDGETITEMPTR_IDX                   30 // QList<QListWidgetItem* >
...
#define SBK_QTWIDGETS_QPAIR_QREAL_QPOINTF_IDX                        37 // QPair<qreal,QPointF >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QPOINTF_IDX                  38 // QList<QPair< qreal,QPointF > >
#define SBK_QTWIDGETS_QPAIR_QREAL_QREAL_IDX                          39 // QPair<qreal,qreal >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QREAL_IDX                    40 // QList<QPair< qreal,qreal > >
