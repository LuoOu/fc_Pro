...
// Type indices
#define SBK_QWEBENGINESCRIPT_IDX                                     19
#define SBK_QWEBENGINESCRIPT_INJECTIONPOINT_IDX                      20
#define SBK_QWEBENGINESCRIPT_SCRIPTWORLDID_IDX                       21
#define SBK_QWEBENGINEHISTORYITEM_IDX                                6
#define SBK_QWEBENGINECERTIFICATEERROR_IDX                           1
#define SBK_QWEBENGINECERTIFICATEERROR_ERROR_IDX                     2
#define SBK_QWEBENGINEPROFILE_IDX                                    16
#define SBK_QWEBENGINEPROFILE_HTTPCACHETYPE_IDX                      17
#define SBK_QWEBENGINEPROFILE_PERSISTENTCOOKIESPOLICY_IDX            18
#define SBK_QWEBENGINEDOWNLOADITEM_IDX                               3
#define SBK_QWEBENGINEDOWNLOADITEM_DOWNLOADSTATE_IDX                 4
#define SBK_QWEBENGINEDOWNLOADITEM_SAVEPAGEFORMAT_IDX                5
#define SBK_QWEBENGINEPAGE_IDX                                       7
#define SBK_QWEBENGINEPAGE_WEBACTION_IDX                             14
#define SBK_QWEBENGINEPAGE_FINDFLAG_IDX                              10
#define SBK_QFLAGS_QWEBENGINEPAGE_FINDFLAG__IDX                      0
#define SBK_QWEBENGINEPAGE_WEBWINDOWTYPE_IDX                         15
#define SBK_QWEBENGINEPAGE_PERMISSIONPOLICY_IDX                      13
#define SBK_QWEBENGINEPAGE_NAVIGATIONTYPE_IDX                        12
#define SBK_QWEBENGINEPAGE_FEATURE_IDX                               8
#define SBK_QWEBENGINEPAGE_FILESELECTIONMODE_IDX                     9
#define SBK_QWEBENGINEPAGE_JAVASCRIPTCONSOLEMESSAGELEVEL_IDX         11
#define SBK_QWEBENGINEVIEW_IDX                                       22
#define SBK_QtWebEngineWidgets_IDX_COUNT                             23
...
#define SBK_QTWEBENGINEWIDGETS_QLIST_QURL_IDX                        1 // const QList<QUrl > &
